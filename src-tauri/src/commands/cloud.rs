...
#[tauri::command]
pub async fn save_to_cloud(state: State<'_, Arc<AppState>>, id: String, source: String) -> Result<CloudFile, AppError> {
...
#[tauri::command]
pub async fn delete_from_cloud(state: State<'_, Arc<AppState>>, id: String) -> Result<(), AppError> {
